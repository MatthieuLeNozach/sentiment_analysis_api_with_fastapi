...
async def test_get_current_user_valid_token():
    encode = {'username': 'testy_mc_testface@example.com', 'user_id': 1, 'role': 'admin', 'has_access_sentiment': True, 'has_access_emotion': True}
...
def test_create_user():
    ...
    with TestingSessionLocal() as db:
        ...
        assert user.has_access_sentiment == False
        assert user.has_access_emotion == False
